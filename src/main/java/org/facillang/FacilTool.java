...
public class FacilTool {
    //arg[0] = facil grammarfile, arg[2]= directory to generate code
    //ex:  ..Facil/src/main/antlr4/Facil.g4  Facil/src/main/java/
    public static void main(String[] args) {
        String fileSeparator = System.getProperty("file.separator");
        String[] arguments = {args[0], "-package", "org.facillang","-o", args[1]+fileSeparator+"org"+fileSeparator+"facillang"};
        Tool.main(arguments);
    }
}
